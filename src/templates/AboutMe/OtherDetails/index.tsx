                        ...
                        {props?.my_stack?.lists.map((item: any, index: any) => {
                            return (
                                <React.Fragment key={index}>
                                    <AnimatedWrapper>
                                        <div className="flex flex-col items-center justify-center border border-[#F1F7FF] rounded-[25px] p-[30px] max-w-[178px] w-full mx-auto">
                                            <ImageLoader
                                                className=""
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-[30px]">
                    {props?.personal_doing?.lists.map((item: any, index: any) => {
                        return (
                            <React.Fragment key={index}>
                                <AnimatedWrapper>
                                    <div className="flex flex-col items-center justify-center border border-[#F1F7FF] rounded-[25px] p-[30px] max-w-[215px] w-full mx-auto">
                                        <ImageLoader
                                            className=""
                                            src={StaticPath(item?.icon)}
                                            alt={item?.icon_alt}
