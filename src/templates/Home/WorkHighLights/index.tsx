                ...
                {props?.work_high_lights?.map((works: any, index: any) => {
                    return (
                        <React.Fragment key={index}>
                            <AnimatedWrapper>
                                <Link className={`group flex flex-col border-[1px] border-[#F0F0F0] rounded-[23px] overflow-hidden max-md:col-span-2 ${index < 2 ? 'md:col-span-2' : 'md:row-start-3'}`} href={works.url}>
